...
// Constants
const NUM_FIXTURE_CLASSES = require('./constants.js').NUM_FIXTURE_CLASSES;
...
class ConditionalVAE {
  ...
  generate(zs){
    ...
    outputsOn = outputsOn.reshape([NUM_FIXTURE_CLASSES, LOOP_DURATION]);   
    outputsVel = outputsVel.reshape([NUM_FIXTURE_CLASSES, LOOP_DURATION]);    
    outputsTS = outputsTS.reshape([NUM_FIXTURE_CLASSES, LOOP_DURATION]); // timshift output
